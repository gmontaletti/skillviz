...
- [`compute_cosine_similarity()`](https://gmontaletti.github.io/skillviz/reference/compute_cosine_similarity.md)
...
- [`compute_skill_similarity()`](https://gmontaletti.github.io/skillviz/reference/compute_skill_similarity.md)
